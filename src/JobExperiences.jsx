    ...
    return (
        ...
        <table>
            ...
            <tr>
                ...
                <td className="job">[Feb 2022 – April 2022]</td>
            </tr>
            <tr>
                <td className="job"><a href="https://www.canapesroom.com/" target="_blank">💼 Canapés Room - Catering Helper</a></td>
                <td className="job">[Sep 2021 – Now]</td>
            </tr>
        </table>
